...
<div class="col-md-6 col-sm-6">
 ...
 @foreach($company_base_job as $job)
<div class="col-md-8 col-md-offset-2">
<div class="box box-custom-css collapsed-box">
  <div class="box-header">
    <div class="col-md-8 col-md-offset-1"><h3 class="box-title"><strong>{{ $job->JobTitle }}</strong> <small class="text-aqua">@foreach (App\Company::where('id',$job->company_id)->get() as $cm)
      {{$cm->company_name}}
    @endforeach</small></h3>
    </div>
