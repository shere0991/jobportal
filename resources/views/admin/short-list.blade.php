...
<p><a id="back-button" href="{{ url('/admin/company/short-list'.'/'.$jobItemIds.'/'.str_slug($title)) }}"><i class="fa fa-arrow-left"></i> Back</a></p>
@endif
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#activity" data-toggle="tab" class="text-aqua">Applicants</a></li>
               ...
               <li class="pull-right"><a class="text-red" href="{{ url('/admin/company/reject-from-shortlist'.'/'.$jobItemIds.'/'.str_slug($title)) }}"><i class="fa fa-ban" aria-hidden="true"></i> Reject Application ({{ $job_applicants_reject_number }})</a></li>
               <li>
                    ...
                    <div class="col-sm-12">
                      <div class="row">
                        ...
                        <div class="col-sm-2">
                          ...
                          <span class="text-aqua">Interview Listing</span>
                          {{-- <span>Reject</span> --}}
                          </div>
                        </div>
                        <!-- /.col -->
...
function Reject(i){
  ...
  var jobId=$('#jobId').val();
  $.post('rejectFromShortList',{'job_post_id':jobId,'user_id':i,'_token':$('input[name=_token]').val()},
    function(response){
    $('#reject-applicants'+i).html("");
