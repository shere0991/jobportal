          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#activity" data-toggle="tab" class="text-green">Applicants</a></li>
               ...
               <li class="pull-right"><a class="text-red" href="{{ url('/admin/company/interview'.'/'.$jobItemIds.'/'.str_slug($title)) }}"><i class="fa fa-ban" aria-hidden="true"></i> Reject Application ({{ $job_applicants_reject_number }})</a></li>
               <li>
...
function Reject(i){
  ...
  var jobId=$('#jobId').val();
  $.post('interview_restoring_reject_list',{'job_post_id':jobId,'user_id':i,'_token':$('input[name=_token]').val()},
    function(response){
      $('#reject-applicants'+i).html("");
