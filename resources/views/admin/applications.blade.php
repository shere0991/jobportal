...
<p><a id="back-button" href="{{ url('/admin/company/application'.'/'.$jobItemIds.'/'.str_slug($title)) }}"><i class="fa fa-arrow-left"></i> Back</a></p>
@endif
        ...
        <div class="col-md-10">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li>
                <a class="text-green" href="{{action('Dashboard\Main@downloadExcelFromApplication',$jobItemIds )}}">Download <i class="fa fa-file-excel-o text-green"></i></a>
              </li>
...
// Search Engine
// $('search-by-uni').on('click',function(){
//   var data=new FormData($('#upload-photo')[0]);
//   console.log(data);
// $.ajax({
//    type: "POST",
//     url: "{{ 'addSlider' }}",
