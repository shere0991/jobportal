   ...
   <!-- Main content -->
    <section class="content">
      ...
      <div class="box">
          ...
          <h3 class="box-title">Archived Job</h3>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="{{ url('/admin/company/application'.'/'.$jobs->id.'/'.str_slug($jobs->JobTitle)) }}" target="_blank">{{ $jobs->JobTitle }}</a>
                    </td>
                    <td>
                    ...
                    <td>{{-- <a href="#" class="btn btn-sm btn-danger btn-flate"><i class="fa fa-trash"></i></a> --}}
                        <div class="btn-group">
                          ...
                          <ul class="dropdown-menu">
                            <li><a href="#" class="text-yellow"  onclick="restore_job('{{ $jobs->id }}')">Restore <i class="fa fa-undo"></i></a></li>
...
function restore_job(i){
  console.log(i);

  $.post('restore_job_from_archive',{'id':i,'_token':$('input[name=_token]').val()},function(res){
    if (res.data=='success') {
      console.log(res.data);
      $('#delete-archive-msg').html('<div class="callout callout-success text-center"><h4>Wow!</h4>Your archived job is restored now! Check Published</div>');
          $("#message").show().fadeOut(8000).queue(function(n) {
          $(this).hide(); n();
          });
          location.href="{{ url('admin/archive-job') }}";
        } 
