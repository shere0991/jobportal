...
<p><a id="back-button" href="{{ url('/admin/company/reject-from-shortlist'.'/'.$jobItemIds.'/'.str_slug($title)) }}"><i class="fa fa-arrow-left"></i> Back</a></p>
@endif
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#activity" data-toggle="tab" class="text-aqua">Applicants</a></li>
               ...
               <li>
                 @include('admin.search-tab-container')
               </li>
            </ul>
