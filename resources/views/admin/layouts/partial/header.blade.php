...
<head>
  ...
  <title>Madina Group | Jobs Portal</title>
  <!-- Tell the browser to be responsive to screen width -->
  <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
  <!-- Bootstrap 3.3.7 -->
  <link rel="stylesheet" href="{{ asset('components/bower_components/bootstrap/dist/css/style.css') }}">
  <link rel="stylesheet" href="{{ asset('components/bower_components/bootstrap/dist/css/bootstrap.min.css') }}">
  {{-- DataTable --}}
  <link rel="stylesheet" href="{{ asset('/components/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css') }}">
  <!-- Font Awesome -->
  ...
  <link rel="stylesheet" href="{{ asset('components/bower_components/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css') }}">
  <!-- Bootstrap time Picker -->
  <link rel="stylesheet" href="{{ asset('components/plugins/timepicker/bootstrap-timepicker.min.css') }}">
  <!-- Select2 -->
  <link rel="stylesheet" href="{{ asset('components/bower_components/select2/dist/css/select2.min.css') }}">
  <!-- Theme style -->
  ...
  <link rel="stylesheet" href="{{ asset('components/plugins/pace/pace.min.css') }}">
  <link rel="stylesheet" href="{{ asset('css/search-tab.css') }}">
