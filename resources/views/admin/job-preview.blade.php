...
{{-- <div class="col-md-8 col-md-offset-2">
  @if(Auth::user())
  <h4 class="text-center"><a href="{{ url('application/'.$job->id.'/'.str_slug($job->JobTitle)) }}" class="btn btn-sm btn-success">Apply Online</a></h4>
  @else
  <h4 class="text-center"><a href="{{ url('login') }}" class="btn btn-sm btn-success">Apply Online</a></h4>
  @endif
</div> --}}
<div class="col-md-8 col-md-offset-2">
