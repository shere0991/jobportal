...
<div id="message"></div>
      ...
      <div class="box box-default box-custom-css">
       ...
       <div class="box">
          ...
          <div class="col-md-6 col-sm-6 col-xs-6">
              <span class="text-aqua pull-right"><i class="fa fa-eye"></i>&nbsp; <a href="">Job Preview</a></span>
          </div>
        </div>
          <div class="box-body custom-box-body">
            <div class="col-md-3 col-sm-3 col-xs-6 text-center">
              <p class="text-aqua">All Applicants</p><br>
              <p><span class="rcorners6"><a href="{{ url('/admin/application'.'/'.$jobItemIds.'/'.str_slug($title)) }}">{{ $applications }}</a></span></p><br>
            </div>
            <div class="col-md-3 col-sm-3 col-xs-6 text-center ">
              <p class="text-aqua">Short Listed</p><br>
              <p><span class="rcorners6"><a id="shortListDiv" href="{{ url('/admin/short-list'.'/'.$jobItemIds.'/'.str_slug($title)) }}">{{ $ShortList }}</a></span></p><br>
            </div>
            <div class="col-md-3 col-sm-3 col-xs-6 text-center">
              <p class="text-aqua">Interview List</p><br>
              <p><span class="rcorners6"><a href="{{ url('/admin/interview'.'/'.$jobItemIds.'/'.str_slug($title)) }}">{{ $Interview }}</a></span></p><br>
            </div>
            <div class="col-md-3 col-sm-3 col-xs-6 text-center">
              <p class="text-aqua">Final List</p><br>
              <p><span class="rcorners6"><a href="{{ url('/admin/final-list'.'/'.$jobItemIds.'/'.str_slug($title)) }}">{{ $FinalList }}</a></span></p><br>
            </div>
          </div>
        ...
        <div class="col-md-10">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#activity" data-toggle="tab" class="text-green">Download</a></li>
              <li><a href="#timeline" data-toggle="tab" class="text-green"><i class="fa fa-file-excel-o"></i></a></li>
            ...
            <div class="tab-content tab-custom-border">
              <div class="active tab-pane" id="activity">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-2">
                          <div class="pull-right">
                            ...
                            <span id="shortlist{{ $applicants->user_id }}" onclick="ShortList('{{ $applicants->user_id }}')" class=" btn-box-tool text-success" title="ShortList">
                          ...
                          <span onclick="Reject('{{ $applicants->user_id }}')" class="btn-box-tool text-danger" title="Reject"><i class="fa fa-times text-red"></i></span><br>
                  ...
                  <ul class="list-inline">
                    ...
                    <li><a href="#" class="link-black text-sm">C.V. Preview <i class="fa fa-eye margin-r-5 text-yellow"></i></a>
                    </li>
                    <li class="pull-right">
...
function ShortList(i){
  ...
  console.log($('#jobId').val()+'user id:'+i);
  var jobId=$('#jobId').val();
  var status=1;
